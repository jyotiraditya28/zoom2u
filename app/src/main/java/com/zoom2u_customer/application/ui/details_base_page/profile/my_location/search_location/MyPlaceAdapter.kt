...
class MyPlaceAdapter(var context: Context?, var counting: MutableList<Model_AddAddress_n_Fav>) : BaseAdapter() {

    private var inflator: LayoutInflater? = null
    private var mCounting: MutableList<Model_AddAddress_n_Fav>
