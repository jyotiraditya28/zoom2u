...
class AutoCompleteTextViewAdapter(context: Context, @LayoutRes private val layoutResource: Int, private val contactList: List<MyLocationResAndEditLocationReq>):
